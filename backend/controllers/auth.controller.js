...
import genToken from "../utils/tocken.js"
...
export const signUp = async (req, res) => {
    try {
        ...
        if (mobile.length > 10) {
            return res.status(400).json({ message: "Mobile must be at most 10 digits." })
        }
...
export const googleAuth = async (req, res) => {
    try {
        ...
        return res.status(500).json(`googlAuth error ${error}`)
    }
}
